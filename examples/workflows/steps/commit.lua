...
Inspect the current diff, stage all request-related files, explicitly including `docs/plans/*.md` ordinary feature-plan documents and `docs/plans/*/*.md` dev-loop planning-folder or bug-fix work-folder documents when they were created or updated for this change, and create a local conventional commit. Do not push, amend, rebase, or reset. Preserve the `Goal: ...`, `Validation: ...`, `Work dir: ...`, `Plan doc: ...`, `Validation doc: ...`, `RCA doc: ...`, and `Repro test: ...` values exactly in output fields when present. Return "committed" with the commit hash/message, or "blocked" if committing is unsafe.]],
      output = {
