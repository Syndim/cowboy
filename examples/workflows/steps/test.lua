...
]] .. context.request_context(ctx) .. context.previous_step_context(ctx, "Implementation result:") .. context.preserve_user_feedback_guidance() .. context.preserve_evidence_guidance() .. context.evidence_record_guidance() .. [[
