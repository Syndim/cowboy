...
Also reject the output unless both paths are stable and the validation guide contains prerequisites, ordered executable steps, evidence requirements, mandatory exit criteria, and continue/revise criteria. Require every exit criterion to pass before the development loop can end; reject ambiguous, incomplete, weakened, or substituted validation guidance.
