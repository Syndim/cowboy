...
clarify:on("clarified", plan)
review_plan:on("approved", confirm_plan)
review_plan:on("changes_requested", plan)
confirm_plan:on("confirmed", implement)
confirm_plan:on("changes_requested", plan)
...
confirm_result:on("confirmed", commit)
confirm_result:on("changes_requested", revise)
